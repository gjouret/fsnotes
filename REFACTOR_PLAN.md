...
- `FSNotesCore/Rendering/Combinators/` — `Parser.swift` (lib) + 16 ported parsers/resolvers/readers:
  ...
  - **Block readers (12.C.5):** FencedCodeBlockReader, HorizontalRuleReader, ATXHeadingReader, HtmlBlockReader, BlockquoteReader, TableReader. 12.C.5.f adds the list reader.
