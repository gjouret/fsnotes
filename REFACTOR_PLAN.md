...
| 12.C.6 — Push CommonMark from 95.1% to 100% (residual failures) | 🚧 IN PROGRESS | (a–g shipped) | With combinator architecture in place, residuals become small grammar edits. **Slices 12.C.6.a–g shipped: 11 spec fixes against the 620 baseline.** Remaining 21 failures across: Links (5, delimiter-stack rewrite for link-in-link literalization — #518, #519, #520, #532, #533); Lists + List items (13, multi-block item children — #278, #289, #290, #292, #293, #300, #312, #313, #318, #320, #321, #324, #325 — needs `ListItem.children: [Block]` redesign, ~107 call sites); Tabs (1, #9, tab-as-indent in nested list, tied to multi-block list family); HTML blocks (1, #175, also multi-block list family); Images (1, #590, accepted FSNotes++ wikilink-extension non-conformance). |
...
- `FSNotesCore/Rendering/Combinators/` — `Parser.swift` (lib) + 17 ported parsers/resolvers/readers:
